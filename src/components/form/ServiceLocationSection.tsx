...
function ServiceLocationSection({
  ...
  errors,
  areaOptions,
}: ServiceLocationSectionProperties) {
  return (
    <fieldset className="create-job-form__section service-location flex">
      <h2 className="service-location__legend legend">Service Location</h2>
      <Input
        {...register('address')}
